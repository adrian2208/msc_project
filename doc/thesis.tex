...
\chapter{Future analysis and improvements}
\section{Optimizing OR-HB ratio for autocorrelation of topological observables}
\section{Topological susceptibility dependence on topological charge definition}
...
\section{$\tau_{int}$ of topological observables using Local Hybrid Monte Carlo algorithms}
\section{Re-analysing the energy density results with the improved lattice field strength tensor}
\section{Do all configurations with $Q=0$ have $q=0$ everywhere}
...
\subsection{Only communicating links of a given parity}
\subsection{SU(3) Overrelaxation}
