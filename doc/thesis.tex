...
To measure observables, it's necessary to generate a substantial amount of gauge configurations. There are several requirements that need to be met in order to produce valuable results.
...
\begin{algorithmic}
\Ensure
\State $n^0_c=n^1_c=n^2_c=n^3_c=0$
\State $i=0$
\While{$(n^0_c+1)(n^1_c+1)(n^2_c+1)(n^3_c+1)< N_{procs}$}
\State $N^{attempted}_{procs} \gets (n^0_c+1)(n^1_c+1)(n^2_c+1)(n^3_c+1)$

\While{$n^i_c$ is not wholly divisible by $\Lambda_x$}
\State $n^i_c \gets n^i_c+1$
\EndWhile
\State $i\gets (i+1)\, \operatorname{mod}(4)$
\EndWhile
\If{$(n^0_c+1)(n^1_c+1)(n^2_c+1)(n^3_c+1) = N_{procs}$}
\State  $N^{usable}_{procs} \gets N_{procs}$
\Else
\State  $N^{usable}_{procs} \gets N^{attempted}_{procs} $
\State $i\gets (i-1)\, \operatorname{mod}(4)$
\State $n^i_c \gets n^i_c-1$
\EndIf
...
\begin{figure}[H]
\centering
\includegraphics[trim=0.0cm 0.0cm 0cm 0.0cm, clip=true,scale = 0.9]{t_squared_v_tOverR_0_squared.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[trim=36cm 4.0cm 0cm 4.0cm, clip=true,scale = 0.4]{q_density_2dSlice_a_0.093.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[trim=0cm 0.0cm 0cm 0.0cm, clip=true,scale = 0.9]{chi_fourthRoot_v_smearRad.pdf}
\caption[]{PLACEHOLDER!!}\label{fig:PLACEHOLDER}
\end{figure}
...
\centering
\includegraphics[trim=0cm 0.0cm 0cm 0.0cm, width=1.15\textwidth]{Q_histogram_SmearRad_0.00_a_0.093.pdf}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.49\textwidth}
\centering
\includegraphics[trim=0cm 0.0cm 0cm 0.0cm, width=1.15\textwidth]{Q_histogram_SmearRad_0.46_a_0.093.pdf}
\end{subfigure}

\bigskip
\begin{subfigure}[b]{0.49\textwidth}
\centering
\includegraphics[trim=0cm 0.0cm 0cm 0.0cm, width=1.15\textwidth]{Q_histogram_SmearRad_0.65_a_0.093.pdf}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.49\textwidth}
\centering
\includegraphics[trim=0cm 0.0cm 0cm 0.0cm, width=1.15\textwidth]{Q_histogram_SmearRad_0.92_a_0.093.pdf}
\end{subfigure}
