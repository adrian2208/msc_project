...
\begin{figure}[H]
\centering
\includegraphics[trim=0.0cm 0.0cm 0cm 0.0cm, clip=true,scale = 0.7]{ChoosingWhichvalsForNandBeta.pdf}
...
\hline \hline Lattice & $\beta$ & $a[fm]$ & $L[fm]$ & $\frac{N_{OR}}{N_{HB}}$&$N_{therm}$ & $N_{decorr}^E$ & $N_{decorr}^Q$& $N_{meas}^E$& $N_{meas}^Q$\\
\hline		   $16^4$ &   $6.0$ & $0.093$ & $1.49$  & 		4		 		 &$2000$  	  & $200$		   & $200$		   & $X$		 & $X$ \\	  
	  		   $12^4$ & 		&     	  & $1.12$  & 		4		 		 &$2000$ 	  & $1$		   	   & $1$  		   & $X$		 & $X$\\ \hline 
	  		   $20^4$ &   $6.13$& $0.075$ & $1.51$  & 		4		 		 &$2000$ 	  & $200$		   & $200$		   & $X$		 & $X$ \\
	  		   $14^4$ & 		&  	 	  & $1.06$  & 		4		 		 &$2000$ 	  & $1$		       & $1$  		   & $X$		 & $X$\\ \hline
	  		   $24^4$ &   $6.26$& $0.062$ & $1.50$  & 		4		 		 &$2000$ 	  & $400$		   & $800$		   & $X$		 & $X$ \\
	  		   $16^4$ & 		&  	 	  & $1.00$  & 		4		 		 &$2000$ 	  & $1$		       & $1$  		   & $X$		 & $X$\\ \hline
	  		   $32^4$ &   $6.46$& $0.047$ & $1.51$  & 		4		 		 &$2000$ 	  & $1350$		   & $4050$		   & $X$		 & $X$ \\
	  		   $22^4$ & 		&  	 	  & $1.04$  & 		4		 		 &$2000$ 	  & $1$		       & $1$  		   & $X$		 & $X$
\end{tabular}
...
\section{Results}
6.46 ENERGY DENSITY - uses 200 + updates between uncorrelated measurements\\
6.46 Q - uses 2700-2800 ish updates between uncorrelated measurements(0.6 pm 0.19 at 2800) (0.58 pm 0.2 at 3200) (0.4 pm 0.15 at 3600)\\
6.46 $Q^2$ - uses 2000-2400 ish updates between uncorrelated measurements (0.48 pm 0.15 at 2400) (0.6 pm 0.2 at 2000)\\\\6.0: 200 updates for Q, 200 updates for E\\6.13: 200 updates for Q, 200 updates for E\\6.26: 800 updates for Q, 400 updates for E 

\subsection{Scale setting with $t^2\langle E\rangle$}
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/t_squared_v_tOverR_0_squared.pdf}
\caption[]{FINAL}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/t0_extrapolate_with_errors.pdf}
\caption[]{LinearFit to get t0/r0 -- FINAL!}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/smearRad_cont_limit.pdf}
\caption[]{LinearFit to get t0/r0 -- FINAL!}\label{fig:PLACEHOLDER}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/t_squared_v_q_contLimit.pdf}
\caption[]{LinearFit to get t0/r0 -- FINAL!}\label{fig:PLACEHOLDER}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/t_squared_v_q_ChiSquared_fitDistribution_HIST.pdf}
\caption[]{LinearFit to get t0/r0 -- FINAL!}\label{fig:PLACEHOLDER}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/Q_v_flowtime_beta_6.0.pdf}
\caption[]{Q v flowtime}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/Q_v_flowtime_beta_6.13.pdf}
\caption[]{Q v flowtime}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/Q_v_flowtime_beta_6.26.pdf}
\caption[]{Q v flowtime}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/Q_v_flowtime_beta_6.46.pdf}
\caption[]{Q v flowtime}\label{fig:PLACEHOLDER}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/QdensityPlots/QdensityDistribution_beta_6_00_658.pdf}
\caption[]{PLACEHOLDER!! ZERO FLOW TIME}\label{fig:PLACEHOLDER}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/QdensityPlots/QdensityDistribution_beta_6_13_1582.pdf}
\caption[]{PLACEHOLDER!! T0/2 FLOW TIME}\label{fig:PLACEHOLDER}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/QdensityPlots/QdensityDistribution_beta_6_26_1804.pdf}
\caption[]{PLACEHOLDER!! T0 FLOW TIME}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/QdensityPlots/QdensityDistribution_beta_6_46_5.pdf}
\caption[]{PLACEHOLDER!! T0 FLOW TIME}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[trim=37cm 0.0cm 35cm 8.0cm, clip=true,scale=0.3]{FINALPLOTS/QdensityPlots/3D/3d_q_densityPlot.pdf}
\caption[]{FROM ENSEMBLE2}\label{fig:PLACEHOLDER}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[trim=37cm 0.0cm 35cm 8.0cm, clip=true,scale=0.3]{FINALPLOTS/QdensityPlots/3D/3d_q_densityPlot2.pdf}
\caption[]{FROM ENSEMBLE3}\label{fig:PLACEHOLDER}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/chi_fourthRoot_v_smearRad.pdf}
\caption[]{FINAL!!}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[trim=1.5cm 0.0cm 0cm 1.0cm, clip=true]{FINALPLOTS/Q_histogram_at_t0_over12.pdf}
\caption[]{FINAL!! $t_0/12$}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[trim=1.5cm 0.0cm 0cm 1.0cm, clip=true]{FINALPLOTS/Q_histogram_at_t0.pdf}
...
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/chi_fourthRoot_continuum_extrapolation.pdf}
...
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/chi_flowTime_independence.pdf}
...
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/R_continuum_extrapolation.pdf}
\caption[]{FINAL!!}\label{fig:PLACEHOLDER}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[trim=0.0cm 0.0cm 0cm 0.0cm, clip=true,scale = 0.9]{IntAutoCorrTime_v_Flowtime.pdf}
\caption[]{Integrated Auto correlation time -- PLACEHOLDER!}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/IntegratedAutoCorrTime_Q.pdf}
\caption[]{Integrated Auto correlation time -- Q}\label{fig:PLACEHOLDER}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/IntegratedAutoCorrTime_Q_squared.pdf}
\caption[]{Integrated Auto correlation time -- Q squared}\label{fig:PLACEHOLDER}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/IntegratedAutoCorrTime_E.pdf}
\caption[]{Integrated Auto correlation time -- E}\label{fig:PLACEHOLDER}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics{FINALPLOTS/ProofOfStatisticalIndependence.pdf}
