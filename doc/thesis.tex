...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{FINALPLOTS/chi_fourthRootAtZeroFlowTime-ContExtrap.pdf}
\caption[Divergence at zero flow time of $\chi_t^{1/4}$]{Fourth root of the topological susceptibility in physical units, measured at $\frac{\sqrt{8t}}{r_0}=0$. Extrapolated to the continuum using a polynomial quadratic in $\frac{a^2}{r_0^2}$.}\label{fig:ZeroFlowTime_chifourthroot}
\end{figure}
