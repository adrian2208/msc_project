...
\begin{equation}
m_{\eta^{\prime}}^{2}=\left.\frac{2 N_{\mathrm{f}}}{F_{\pi}^{2}} \chi_{t}\right|_{N_{\mathrm{f}}=0} + \mathcal{O}\left( 1/N^2) \right)
\end{equation}
...
R = 0.233(45).
\end{equation}
This seems to massively disfavour the dilute instanton gas model.
